...
contract EFT is ERC20, Ownable {
  ...
  //  uint256 public extraFeeOnSell = 4;
    ...
    address public _futureDeployer = 0x30073C6908EF85477FbD2BAD0482E5fA696Ee6F5;
    ...
    constructor() ERC20("ETH Fan Token Ecosystem", "EFT") {
        ...
        dividendTracker.excludeFromDividends(_futureDeployer);
        ...
        excludeOrIncludeFromFees(_futureDeployer, true);
        ...
        excludeOrIncludeFromMaxTx(_futureDeployer, true);
        ...
        excludeOrIncludeFromMaxWallet(_futureDeployer, true);
